  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground text-sm font-semibold">may have some errors, raise pr @ <a href='https://github.com/savarbhasin/college-timetable' className='text-blue-600 hover:underline'>github</a></p>
